    ...
    value: function value(url, method, data, options) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this[request](opts).then(function (res) {
          var result = _this[dataCtl](res);
          if (typeof errFn === 'function') {
            var _errFn = errFn(res),
                _errFn$success = _errFn.success,
                success = _errFn$success === undefined ? true : _errFn$success,
                _errFn$message = _errFn.message,
                message = _errFn$message === undefined ? 'errorControl return value is wrong' : _errFn$message;
